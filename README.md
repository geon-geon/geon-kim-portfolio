...
3번은 기간별 관계 방향과 보정 q값을 같은 크기의 카드로 제시합니다. 기간별 계수 크기를 비교하던 그래픽은 제거하고, 계수는 상세 표에 남겼습니다. 당일 연관성으로 해석하며 인과효과나 매매성과로 표시하지 않습니다. 프로젝트 01·02·03은 공통 배지와 제목 컴포넌트를 사용합니다.

## 수식 조판

KaTeX 0.18.7로 LaTeX 수식을 미리 조판한 HTML+MathML을 제공합니다. Computer Modern 계열의 KaTeX 글꼴과 CSS를 `assets/katex/`에 로컬 제공하며 라이선스를 동봉합니다. 방문자 브라우저에서 수식용 JavaScript나 외부 CDN을 사용하지 않습니다.
